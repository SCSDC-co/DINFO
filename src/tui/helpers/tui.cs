...
public static class TuiHelper
{
	...
	public static async Task PrintFileInfo(string targetFile)
	{
	...
	public static void PrintSummary()
	{
		...
		separator.Justification = Justify.Left;
		separator.Style = new Style(Color.Green);
		...
		summaryPanel.BorderStyle = new Style(Color.Green);
		summaryPanel.Header = new PanelHeader("[bold green] SUMMARY [/]");
